...
flowchart TD
	...
	classDef schemaStyle fill:#DBEAFE,stroke:#2563EB,stroke-width:1.5px,stroke-dasharray:4 4;
	classDef storageStyle fill:#D1FAE5,stroke:#059669,stroke-width:1.5px;
	classDef lgStyle fill:#FEF3C7,stroke:#D97706,stroke-width:1.5px;
	classDef uiStyle fill:#FCE7F3,stroke:#DB2777,stroke-width:1.5px;
...
graph TD
    ...
    --> S5["<b>Step 1.5: GB/T 13296-2023 黄金基准测试集</b><br/>• 固化 S30408 与 S32169 标准规则 JSON<br/>• 构造 5 份覆盖全分支的模拟质保书<br/>• Vitest 单元与边界测试 (覆盖率 ≥ 95%)"]
```
